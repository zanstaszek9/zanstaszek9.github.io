const audioFiles = {
    serce: [
        ...
        `09.Skurczowy-rozdwojenie-z-p-max-nad-z-aortalna-rozdwojenie-drugiego-tonu-serca.mp3`,
        `10.Prawidłowe-tony-serca-z-aortalna.mp3`,
        `11.Szmer-skurczowy-z-p-max-nad-z-pnia-płucnego.mp3`,
        `12.Skurczowy-rozdwojenie-z-p-max-w-punkcie-Erba-sztywne-rozdwojenie-drugiego-tonu-serca.mp3`,
